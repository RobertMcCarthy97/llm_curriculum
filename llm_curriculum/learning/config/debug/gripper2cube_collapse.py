...
def get_config():
    ...
    config.do_early_stopping = False
    config.early_stop_success_threshold = 0.95
    # logging
    ...
    config.wandb.group = "gripper2cube-collapse-debug"
    config.wandb.job_type = "training"
    config.wandb.name = "move_gripper_to_cube-single-standard"
