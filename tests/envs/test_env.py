...
def check_single_task_rollout(
    env, single_task_name, task_i, use_oracle_action=False, parent=None, prev_task=None
):
    """
...
def check_multi_single_resets(env, tasks, i):
    ...
    for i in range(2):
        ...
        valid_tasks.index(task_name)
        check_single_task_rollout(env, single_task_name=None, task_i=None)
...
def test_env():
    ...
    for i, task in enumerate(valid_tasks):
        ...
        check_single_task_rollout(env, task, i)
        check_single_task_rollout(env, task, i, use_oracle_action=True)
    ...
    for pair in pairs:
        ...
        check_single_task_rollout(env, task, task_i, prev_task=prev_task)
    ...
    for pair in pairs:
        ...
        check_single_task_rollout(env, child, task_i, parent=parent)
